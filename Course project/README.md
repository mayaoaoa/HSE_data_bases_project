...
Один пассажир может купить несколько билетов на разные рейсы

**Самолёты**
+ марка и модель самолёта
+ авиакомпания
+ общее количество мест
Самолёт может участвовать в нескольких рейсах
...
+ код IATA
+ контактные данные (телефон, e-mail)
Аэропорт может быть пунктом отправления или прибытия для нескольких рейсов
